...
Branch: main @ 52010b2 (AcademicDecisionAgent Phase 2 — ProgramProvider/TauProgramProvider, complete)
...
## Next step
Get direction on the pytest leak before running pytest broadly again (unrelated to the AcademicDecisionAgent track). Phase 2 (ProgramProvider) is done; next phase per roadmap.md is unscoped — ready whenever approved.
